# https://github.com/philtabor/Youtube-Code-Repository/blob/master/ReinforcementLearning/PolicyGradient/SAC/networks.py
...
class ActorNetwork(nn.Module):
    ...
    def sample_normal(self, state, reparameterize=True):
        ...
        # from the appendix of the paper. how they handle the sacling of the action
...
class Agent:
    ...
    def learn(self):
        ...
        state_ = torch.tensor(
            new_state, dtype=torch.float).to(self.actor.device)
        ...
        # take the min to make learning more stable
